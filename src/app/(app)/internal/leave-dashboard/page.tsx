  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {dashboard.monthStats?.length > 0 && (
        <div id="section-month-stats" className="rounded-xl border border-[var(--border)] bg-[var(--card)] p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        {dashboard.sickLeaders?.length > 0 && (
          <div id="section-sick" className="rounded-xl border border-red-200 dark:border-red-800 bg-[var(--card)] p-4">
        ...
        {dashboard.bridgeSuspects?.length > 0 && (
          <div id="section-bridge" className="rounded-xl border border-orange-200 dark:border-orange-800 bg-[var(--card)] p-4">
