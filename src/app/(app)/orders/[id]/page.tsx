                      ...
                      <div className="pb-5 flex-1">
                        ...
                        <div className="mt-1.5 flex items-center gap-2 flex-wrap">
                          <label className={cn(
                            ...
                            <input type="file" className="hidden" accept=".jpg,.jpeg,.png,.webp,.gif,.pdf,.doc,.docx,.xls,.xlsx" onChange={async e => {
