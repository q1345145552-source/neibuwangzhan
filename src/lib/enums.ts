...
export const ENUMS = {
  ...
  "notifications.type": ["", "issue_assigned", "leave_requested", "contract_overdue", "eval_done", "mention", "leave_overdue", "problem_assigned", "problem_followup", "problem_accepted", "problem_rejected"],
  ...
  "problems.status": ["待处理", "跟进中", "已解决", "老板验收", "搁置"],
